            ...
            <table class="table table-hover" style="text-align: center;">
                ...
                <tbody>
                    <tr v-for="item in items" :key="item.order.id">
                        ...
                        <td>
                            <span>{{ item.order.address.slice(0,10)+(item.order.address.length<=10?"":"...") }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <button @click="update_order(item.order.id,2)" v-if="item.order.status==1" type="button" class="btn out btn-primary">发货</button>                              
                            <button @click="update_order(item.order.id,4)" v-if="item.order.status!=4" type="button" class="btn out btn-danger">退款</button>                              
                        </td>
                    </tr>
                </tbody>
            </table>
