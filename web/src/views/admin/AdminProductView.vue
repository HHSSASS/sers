                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input @change="add_img" class="form-control" type="file" accept="image/*" id="add_img">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea v-model="new_product.price" class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="请输入定价(0,10000)"></textarea>
                        </div>
                    </div>
                                    ...
                                    <div class="modal-dialog modal-lg" style="text-align: left;">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="formFile" class="form-label">产品图片</label>
                                                    <input @change="update_img($event,product)" class="form-control" type="file" accept="image/*" :id="'update_img'+product.id">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleFormControlTextarea1" class="form-label">产品名称</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">产品定价</label>
                                                    <textarea v-model="product.price" class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="请输入定价(0,10000)"></textarea>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
...
export default{
    ...
    setup(){
            ...
            $.ajax({
                ...
                success(resp){
                    if(resp.message==="successful"){
                        ...
                        var obj = document.getElementById('update_img'+product.id); 
                        obj.value='';
        ...
        const cancel=(id)=>{
            ...
            var obj = document.getElementById('update_img'+id); 
            obj.value='';
            pull_page(current_page);
        }
